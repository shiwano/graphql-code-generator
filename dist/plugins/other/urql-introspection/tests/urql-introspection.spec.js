...
describe('Urql Introspection Plugin', () => {
    ...
    describe('JavaScript', () => {
        it('should use es2015 module by default', async () => {
            const jsContent = await plugin(schema, [], {}, {
                outputFile: 'foo.js',
            });
            const jsxContent = await plugin(schema, [], {}, {
                outputFile: 'foo.jsx',
            });
    ...
    describe('TypeScript', () => {
        it('should use es2015 module by default', async () => {
            const tsContent = await plugin(schema, [], {}, {
                outputFile: 'foo.ts',
            });
            const tsxContent = await plugin(schema, [], {}, {
                outputFile: 'foo.tsx',
            });
...
//# sourceMappingURL=urql-introspection.spec.js.map