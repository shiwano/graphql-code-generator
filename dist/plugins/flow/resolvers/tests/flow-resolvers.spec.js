...
describe('Flow Resolvers Plugin', () => {
    describe('Enums', () => {
      ...
      `);
            ...
            expect(result.content).toContain(`export type MyEnumResolvers = EnumResolverSignature<{| A?: *, B?: *, C?: * |}, $ElementType<ResolversTypes, 'MyEnum'>>;`);
        });
...
//# sourceMappingURL=flow-resolvers.spec.js.map