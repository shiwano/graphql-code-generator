...
describe('Flow Plugin', () => {
      ...
      export const MyEnumValues = Object.freeze({
        ...
        interface MyInterface {
          ...
          bar: String!
            ...
            const result = (await plugin(schema, [], { useFlowExactObjects: false }, { outputFile: '' }));
            expect(result.content).toBeSimilarStringTo(`
  ...
  `);
    ...
    `);
        const content = (await plugin(schema, [], { addUnderscoreToArgsType: true, skipTypename: true }, { outputFile: '' }));
