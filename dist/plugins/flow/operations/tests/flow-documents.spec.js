    ...
    describe('Naming Convention & Types Prefix', () => {
      ...
      `);
            const result = mergeOutputs([
                ...
                ], { namingConvention: 'change-case-all#lowerCase' }, { outputFile: '' }),
            ]);
      ...
      `);
            const result = mergeOutputs([
                ...
                ], { typesPrefix: 'i', namingConvention: 'change-case-all#lowerCase' }, { outputFile: '' }),
            ]);
    ...
    describe('__typename', () => {
      ...
      `);
            const result = mergeOutputs([
                ...
                ], { nonOptionalTypename: true }, { outputFile: '' }),
            ]);
            expect(result).toBeSimilarStringTo(`
      export type UnionTestQuery = ({
        ...{ __typename: 'Query' },
...
`);
      ...
      `);
            const result = mergeOutputs([
                ...
                ], { skipTypename: true, flattenGeneratedTypes: true }, { outputFile: '' }),
            ]);
            expect(result).toMatchSnapshot();
            validateFlow(result);
        });
      ...
      `);
            const result = mergeOutputs([
                ...
                ], { skipTypename: true, flattenGeneratedTypes: true, preResolveTypes: true }, { outputFile: '' }),
            ]);
            expect(result).toMatchSnapshot();
            validateFlow(result);
        });
      ...
      `);
            ...
            expect(result).toBeSimilarStringTo(`export type MeQueryVariables = {
    ...
    describe('Output options', () => {
      ...
      `);
            const result = mergeOutputs([
                ...
                ], { skipTypename: true, useFlowExactObjects: false }, { outputFile: '' }),
            ]);
            expect(result).toBeSimilarStringTo(`
      export type CurrentUserQuery = { me?: ?({
        ...$Pick<User, { id: *, username: *, role?: * }>,
      ...
      `);
            ...
            ], { skipTypename: true, useFlowReadOnlyTypes: true }, { outputFile: '' }));
    ...
    describe('Directives handling', () => {
      ...
      `);
            const result = mergeOutputs([
                ...
                ], { preResolveTypes: true }, { outputFile: '' }),
            ]);
            expect(result).toBeSimilarStringTo(`
      export type UserQueryVariables = {
        showAddress: $ElementType<Scalars, 'Boolean'>,
...
//# sourceMappingURL=flow-documents.spec.js.map