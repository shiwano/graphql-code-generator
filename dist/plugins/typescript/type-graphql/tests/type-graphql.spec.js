...
describe('type-graphql', () => {
    ...
    `);
        const result = (await plugin(schema, [], { decoratorName: { type: 'Foo', field: 'Bar', interface: 'FooBar' } }, { outputFile: '' }));
        expect(result.content).toBeSimilarStringTo(`
        @TypeGraphQL.Foo()
        export class Test {
          __typename?: 'Test';
    ...
    `);
        const result = (await plugin(schema, [], { scalars: { DateTime: 'Date' } }, { outputFile: '' }));
        expect(result.content).toBeSimilarStringTo(`
      @TypeGraphQL.ObjectType()
      export class A {
        __typename?: 'A';
    ...
    `);
        ...
        expect(result.content).not.toBeSimilarStringTo(`TypeGraphQL.registerEnumType(RegularEnum, { name: 'RegularEnum' });`);
        expect(result.content).toBeSimilarStringTo(`TypeGraphQL.registerEnumType(TypeGraphQlEnum, { name: 'TypeGraphQlEnum' });`);
        expect(result.content).toBeSimilarStringTo(`export type IRegularInterfaceType = {
        id?: Maybe<Scalars['ID']>;
      };`);
        expect(result.content).toBeSimilarStringTo(`
      @TypeGraphQL.InterfaceType()
      export abstract class ITypeGraphQlInterfaceType {
        ...
        expect(result.content).toBeSimilarStringTo(`export type RegularType = {
        __typename?: 'RegularType';
        id?: Maybe<Scalars['ID']>;
      };`);
        expect(result.content).toBeSimilarStringTo(`@TypeGraphQL.ObjectType()
      export class TypeGraphQlType {
        __typename?: 'TypeGraphQLType';
        @TypeGraphQL.Field(type => TypeGraphQL.ID, { nullable: true })
        id!: Maybe<Scalars['ID']>;
      }`);
        expect(result.content).toBeSimilarStringTo(`export type RegularInputType = {
        id?: Maybe<Scalars['ID']>;
      };`);
        expect(result.content).toBeSimilarStringTo(`@TypeGraphQL.InputType()
...
//# sourceMappingURL=type-graphql.spec.js.map