...
describe('Components', () => {
    ...
    `;
        const content = (await plugin(schema, [{ location: '', document: documents }], { componentType: StencilComponentType.class }, { outputFile: '' }));
    ...
    `;
        const { content } = (await plugin(schema, [{ location: '', document: documents }], { componentType: StencilComponentType.functional }, { outputFile: '' }));
...
//# sourceMappingURL=stencil-apollo.spec.js.map