...
describe('TypedDocumentNode', () => {
    ...
    `);
        const res = (await plugin(schema, [{ location: '', document: ast }], { dedupeFragments: true }, { outputFile: '' }));
    ...
    `);
        const res = (await plugin(schema, [{ location: '', document: ast }], { dedupeFragments: false }, { outputFile: '' }));
    ...
    describe('addTypenameToSelectionSets', () => {
      ...
      `);
            const res = (await plugin(schema, [{ location: '', document: ast }], { addTypenameToSelectionSets: true }, { outputFile: '' }));
...
//# sourceMappingURL=typed-document-node.spec.js.map