...
describe('C#', () => {
    describe('Using directives', () => {
      ...
      `);
        ...
        each(['Newtonsoft.Json', 'System.Text.Json']).it(`Should include configured '%s' using directives`, async (source) => {
            const schema = buildSchema(/* GraphQL */ `
          enum ns {
            dummy
          }
    ...
    describe('Types', () => {
      ...
      `);
        ...
        each(['Newtonsoft.Json', 'System.Text.Json']).it(`Should generate properties for types using '%s' source`, async (source) => {
            const schema = buildSchema(/* GraphQL */ `
          type User {
            id: Int
            email: String
    ...
    describe('GraphQL Value Types', () => {
        describe('Scalar', () => {
            each(['Newtonsoft.Json', 'System.Text.Json']).it(`Should generate properties for mandatory scalar types using '%s' source`, async (source) => {
                const schema = buildSchema(/* GraphQL */ `
...
//# sourceMappingURL=c-sharp.spec.js.map