...
describe('C# Operations', () => {
    describe('Namespaces', () => {
      ...
      `);
            const result = (await plugin(schema, [{ location: '', document: operation }], {}, { outputFile: '' }));
    ...
    describe('Query', () => {
      ...
      `);
            const result = (await plugin(schema, [{ location: '', document: operation }], { typesafeOperation: true }, { outputFile: '' }));
            expect(result.content).toBeSimilarStringTo(`
...
//# sourceMappingURL=c-sharp-operations.spec.js.map