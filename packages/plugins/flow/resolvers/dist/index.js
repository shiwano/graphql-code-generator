...
class FlowResolversVisitor extends visitorPluginCommon.BaseResolversVisitor {
    constructor(pluginConfig, schema) {
        ...
        autoBind(this);
        this.setVariablesTransformer(new flow.FlowOperationVariablesToObject(this.scalars, this.convertName, this.config.namespacedImportName));
    }
    _getScalar(name) {
    ...
    ScalarTypeDefinition(node) {
        ...
        return new visitorPluginCommon.DeclarationBlock({
            ...
            .withBlock([visitorPluginCommon.indent(`...GraphQLScalarTypeConfig<${baseName}, any>`), visitorPluginCommon.indent(`name: '${node.name}'`)].join(', \n'))
            .string;
    }
