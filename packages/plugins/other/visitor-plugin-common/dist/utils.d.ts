...
export declare function transformComment(
...
export declare function convertNameParts(
  str: string,
  func: (str: string) => string,
  removeUnderscore?: boolean
): string;
export declare function buildScalarsFromConfig(
  schema: GraphQLSchema | undefined,
  config: RawConfig,
  defaultScalarsMapping?: NormalizedScalarsMap,
  defaultScalarType?: string
): ParsedScalarsMap;
export declare function buildScalars(
  schema: GraphQLSchema | undefined,
...
export declare function wrapTypeWithModifiers(
  baseType: string,
  type: GraphQLOutputType | GraphQLNamedType,
  options: WrapModifiersOptions
): string;
export declare function removeDescription<
  T extends {
