...
class VueApolloVisitor extends visitorPluginCommon.ClientSideBaseVisitor {
    constructor(schema, fragments, rawConfig, documents) {
        super(schema, fragments, rawConfig, {
            withCompositionFunctions: visitorPluginCommon.getConfigValue(rawConfig.withCompositionFunctions, true),
            vueApolloComposableImportFrom: visitorPluginCommon.getConfigValue(rawConfig.vueApolloComposableImportFrom, '@vue/apollo-composable'),
            vueCompositionApiImportFrom: visitorPluginCommon.getConfigValue(rawConfig.vueCompositionApiImportFrom, '@vue/composition-api'),
