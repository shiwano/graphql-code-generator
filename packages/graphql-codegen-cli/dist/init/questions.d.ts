...
export declare function getPluginChoices(
  ...
  inquirer.AllChoiceMap<inquirer.Answers>,
  inquirer.AllChoiceMap<inquirer.AllChoiceMap<inquirer.Answers>>
>[];
export declare function getOutputDefaultValue(
  answers: Answers
): 'src/generated/graphql.tsx' | 'src/generated/graphql.ts' | 'src/generated/graphql.js';
